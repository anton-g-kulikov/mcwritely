...
## [2.1.0] - 2026-02-08
### Fixed
- Improved Apply reliability across Electron editors and Notion (fewer false post-Apply errors).
- Corrected text is more reliably preserved on the clipboard after Apply (including normalized clipboard variants).
- Removed intrusive post-Apply selection verification that caused visible selection animation.
