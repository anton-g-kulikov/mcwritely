...
- [ ] **CORE-TASK-010: Verified replacement results + truthful UI behavior** - 🟡 **IN PROGRESS** - Don’t close panel unless replacement is verified; show actionable failure states (Est: 4-8h)
